...
function initCatDecorations() {
  // Add floating cat paws to the page
  const pawPositions = [
    { top: "10%", left: "5%" },
    { top: "20%", right: "10%" },
    { top: "60%", left: "15%" },
  ...
  pawPositions.forEach((position, index) => {
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("Tarcat website initialized");

  // Initialize cat decorations
  initCatDecorations();
  ...
  // Initialize how to play
  if (typeof initHowToPlay === "function") {
    initHowToPlay();
  }

  // Initialize all modules
  // Header and footer are now handled by their respective files
